...
export const GRANT_SCHEMA: Schema = {
  $id: 'https://schemas.agentictrust.io/grant-node/v2.0.1/schema.json',
  ...
  properties: {
    'display-name': { type: 'string', description: 'Display name for the grant program (distinct from ENS path)' },
  ...
  recommended: ['display-name', 'description', 'url', 'status', 'budget', 'token']
};
