...
export const APPLICATION_SCHEMA: Schema = {
  $id: 'https://schemas.agentictrust.io/application-node/v2.0.1/schema.json',
  ...
  properties: {
    'display-name': { type: 'string', description: 'Display name for the application (distinct from ENS path)' },
  ...
  recommended: ['display-name', 'description', 'url', 'status']
};
