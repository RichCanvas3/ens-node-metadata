...
export const COMPANY_SCHEMA: Schema = {
  $id: 'https://schemas.agentictrust.io/company-node/v2.0.1/schema.json',
  ...
  properties: {
    'display-name': { type: 'string', description: 'Display name for the company (distinct from ENS path)' },
