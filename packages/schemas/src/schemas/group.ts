...
export const GROUP_SCHEMA: Schema = {
  $id: 'https://schemas.agentictrust.io/group-node/v2.0.1/schema.json',
  ...
  properties: {
    'display-name': { type: 'string', description: 'Display name for the group (distinct from ENS path)' },
  ...
  recommended: ['display-name', 'lead', 'avatar', 'url', 'description']
};
